...
const readOne = (req, res) => {
    ...
    LikeEvent.findById(id).populate('user')
    .then((data) => {
        if(data){
...
const updateData = (req, res) => {
    ...
    LikeEvent.findByIdAndUpdate(id, body, {
        new: true
    })
        .then((data) => {
            if(data){
...
const deleteData = (req, res) => {
    ...
    LikeEvent.findById(id)
       ...
       //changed promise
       .then((data) => {
            console.log('LikeEvent removed');
            //////Delete Image/////////
            deleteImage(imagePath);
            ///////////////////////////
            res.status(200).json({
                "message": `LikeEvent with id: ${id} deleted sucussfully`
            })
       })
    .catch((err) => {
        console.error(err);
